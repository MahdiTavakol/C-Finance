...
void add_four_real_vectors_exp_tmpl()
{
	...
	cout << "*** add_four_real_vectors_exp_tmp() ***" << endl;
	...
	cout << "typedef(result) = " << typeid(result).name() << endl << endl;
...
void vector_conversion_operator()
{
	...
	cout << "*** vector_conversion_operator() ***" << endl;
	...
	cout << "typeof(vec_result) = " << typeid(vec_result).name() << endl << endl;
